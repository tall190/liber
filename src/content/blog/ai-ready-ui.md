...
*[AI-ready E2E — AI가 코드를 짜는 시대, 품질 검증은 누가 하나요?](/liber/blog/ai-ready-e2e) — 같은 data-testid를 QA 관점에서. Playwright vs Selenium 비교와 aria-busy 패턴.*
